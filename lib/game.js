...
// const getOurTailScore = (snakes, you, testPosition) => {
//   if (you != null) {
//     const ourTail = you.body[you.body.length - 1];
//
//     if (testPosition.x !== ourTail.x && testPosition.y !== ourTail.y && you.health >= 30) {
//       return 100;
//     }
//   }
//
...
const calculateDirectionScore = body => {
  const scores = coordinates.map(direction => {
    ...
    // const ourTailScore = getOurTailScore(body.board.snakes, body.you, testPosition);
    // if (ourTailScore) {
    //   return Object.assign({}, result, {
    //     score: ourTailScore,
    //     numVisited,
